        ...
        <div class="row">
            <div class="col--6 mx-auto">
                <div class="card border-0 rounded-0 p-4 shadow">
                    <h2 class="text-center text-uppercase -3">Admin Login</h2>
                    <form action="" method="post">
                        ...
                        <div class="form-group -4">
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="user_name" id="user_name" class="form-control rounded-0 border-left-0" placeholder="User Name">
                            </div>
                        </div>
                        <div class="form-group -4">
                            <div class="input-group input-group-lg">
